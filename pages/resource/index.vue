    ...
    <div class="s-container resource-list">
      <template v-if="resourceData && resourceData.length > 0">
        <div v-for="resource in resourceData" :key="resource._id">
          ...
          <div v-if="resource.resource && resource.resource.length > 0" class="s-row" style="margin-bottom: 20px;">
            <div v-for="resourceItem in resource.resource" :key="resourceItem.id" class="resource-item-wrap s-col-xl-12 s-col-lg-15 s-col-md-20 s-col-sm-30 s-col-xs-30">
                ...
                <a :href="resourceItem.url" class="resource-item-link" target="_blank">
                  <div class="resource-info-title">
                    <div class="resource-item-poster">
                      <img v-if="resourceItem.logo" :src="resourceItem.logo" alt="资源海报" />
...
export default {
  components: { BillBoard, TitleBar, Card, CardEmpty },
  async asyncData({app}){
